...
def seed_users(conn):
    with conn.cursor() as cur:
        ...
        colin_staff_id = _insert_get_id(cur, """
            INSERT INTO sys_staff (username, password_hash, real_name, email, phone, status)
        ...
        """, None)
        if colin_uid:
            cur.execute("INSERT INTO usr_infos (user_id) VALUES (1)")
        ...
        cur.execute("""
            INSERT INTO usr_addresses (user_id, consignee, phone, country, province, city, district, detail, zip_code, tag, is_default)
            VALUES (1, '陈科林', '13900139002', '中国', '广东省', '广州市', '天河区', '珠江新城华夏路16号富力盈凯广场3001', '510623', 'home', NULL)
        """)
    conn.commit()
